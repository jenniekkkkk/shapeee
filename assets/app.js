/******/ (() => {
  ...
  \*********************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          if (dep.get(effect2) !== effect2._trackId) {
            ...
            if (true) {
              (_a = effect2.onTrack) == null
                ...
                : _a.call(
                    effect2,
                    (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.extend)({ effect: effect2 }, debuggerEventExtraInfo)
                  );
            }
          }
        }
        ...
        function trigger(target, type, key, newValue, oldValue, oldTarget) {
          ...
          if (type === 'clear') {
            ...
            depsMap.forEach((dep, key2) => {
              if (
                key2 === 'length' ||
                (!(0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.isSymbol)(key2) && key2 >= newLength)
              ) {
                deps.push(dep);
              }
            });
        ...
        const isNonTrackableKeys = /* @__PURE__ */ (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.makeMap)(
        ...
        function createInstrumentationGetter(isReadonly, shallow) {
          ...
          return (target, key, receiver) => {
            ...
            return Reflect.get(
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.hasOwn)(instrumentations, key) && key in target
                ? instrumentations
                : target,
              key,
              receiver
        ...
        const toReactive = (value) =>
          (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.isObject)(value) ? reactive(value) : value;
        const toReadonly = (value) =>
          (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.isObject)(value) ? readonly(value) : value;
        ...
        class ComputedRefImpl {
          ...
          get value() {
            ...
            if (
              ...
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_0__.hasChanged)(self._value, (self._value = self.effect.run()))
            ) {
  ...
  \*************************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ TrackOpTypes: () =>
            /* reexport safe */ _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.TrackOpTypes,
          /* harmony export */ TriggerOpTypes: () =>
            /* reexport safe */ _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.TriggerOpTypes,
...
`,
        ...
        function emit(instance, event, ...rawArgs) {
          ...
          if (true) {
            ...
            if (emitsOptions) {
              if (!(event in emitsOptions) && true) {
                if (
                  !propsOptions ||
                  !((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(event) in propsOptions)
                ) {
                  warn$1(
                    `Component emitted event "${event}" but it is neither declared in the emits option nor as an "${(0,
                    _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(event)}" prop.`
                  );
                }
              } else {
          ...
          if (true) {
            ...
            if (
              ...
              props[(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(lowerCaseEvent)]
            ) {
              warn$1(
                `Event "${lowerCaseEvent}" is emitted in component ${formatComponentName(
                  instance,
                  instance.type
                )} but the handler is registered for "${event}". Note that HTML attributes are case-insensitive and you cannot use v-on to listen to camelCase events when using in-DOM templates. You should probably use "${(0,
          ...
          let handlerName;
          let handler =
            props[(handlerName = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(event))] || // also try camelCase event handler (#2249)
            props[
              (handlerName = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(
        ...
        function isEmitListener(options, key) {
          ...
          return (
            (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(options, key[0].toLowerCase() + key.slice(1)) ||
            ...
            if (vnode.shapeFlag & 4) {
              ...
              result = normalizeVNode(
                render2.length > 1
                  ...
                  : render2(true ? (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.shallowReadonly)(props) : 0, null)
              );
...
If this is a native custom element, make sure to exclude it from component resolution via compilerOptions.isCustomElement.`
            ...
            warn$1(
              `resolve${(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.capitalize)(
                type.slice(0, -1)
        ...
        function createSuspenseBoundary(
          ...
          const timeout = vnode.props
            ? (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toNumber)(vnode.props.timeout)
            : void 0;
          if (true) {
        ...
        function injectHook(type, hook, target = currentInstance, prepend = false) {
          if (target) {
            ...
            const apiName = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.toHandlerKey)(
        ...
        function defineComponent(options, extraOptions) {
          return (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(options)
            ? // #8326: extend call and options.name access are considered side-effects
              ...
              /* @__PURE__ */ (() =>
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({ name: options.name }, extraOptions, {
                  setup: options,
                }))()
            : options;
        }
                ...
                loader()
                  ...
                  .then((comp) => {
                    ...
                    if (
                      true &&
                      comp &&
                      !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isObject)(comp) &&
        ...
        const publicPropertiesMap =
          ...
          /* @__PURE__ */ (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)(/* @__PURE__ */ Object.create(null), {
            ...
            $watch: (i) =>
              __VUE_OPTIONS_API__ ? instanceWatch.bind(i) : _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP,
          });
        const isReservedPrefix = (key) => key === '_' || key === '$';
        const hasSetupBinding = (state, key) =>
          state !== _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ &&
          !state.__isScriptSetup &&
          (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(state, key);
        const PublicInstanceProxyHandlers = {
          get({ _: instance }, key) {
            ...
            if (publicGetter) {
              ...
              (!(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(key) || // #1091 avoid internal isRef/isVNode checks on component instance leading
        ...
        _vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, PublicInstanceProxyHandlers, {
          get(target, key) {
        ...
        function normalizePropsOrEmits(props) {
          return (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(props)
        ...
        function mergeModels(a, b) {
          if (!a || !b) return a || b;
          if (
            (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(a) &&
            (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(b)
          )
            return a.concat(b);
        ...
        function applyOptions(instance) {
          ...
          if (computedOptions) {
            for (const key in computedOptions) {
              ...
              const set =
                !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(opt) &&
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(opt.set)
        ...
        function mergeObjectOptions(to, from) {
          return to
            ? (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)(/* @__PURE__ */ Object.create(null), to, from)
            : from;
        }
        function mergeEmitsOrPropsOptions(to, from) {
          if (to) {
            if (
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(to) &&
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(from)
            ) {
...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createMyApp = () => createApp(App)\``
            ...
            for (const key in rawCurrentProps) {
              if (
                ...
                (!(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(rawProps, key) && // it's possible the original props was passed in as kebab-case
                  ...
                  ((kebabKey = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hyphenate)(key)) === key ||
                    !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(rawProps, kebabKey)))
              ) {
                if (options) {
                  if (
          ...
          if (rawProps) {
            for (let key in rawProps) {
              ...
              if (
                ...
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(
                  options,
                  (camelKey = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.camelize)(key))
                )
              ) {
          ...
          if (opt != null) {
            ...
            if (hasDefault && value === void 0) {
              ...
              if (
                opt.type !== Function &&
                !opt.skipFactory &&
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(defaultValue)
              ) {
        ...
        function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
          if ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(rawRef)) {
            rawRef.forEach((r, i) =>
              setRef(
                r,
                oldRawRef &&
                  ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(oldRawRef) ? oldRawRef[i] : oldRawRef),
                parentSuspense,
                vnode,
                isUnmount
              )
          ...
          const refs =
            owner.refs === _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ ? (owner.refs = {}) : owner.refs;
              ...
              const doSet = () => {
                if (rawRef.f) {
                  const existing = _isString
                    ...
                    : ref.value;
                  if (isUnmount) {
                    (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(existing) &&
                      (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.remove)(existing, refValue);
                  } else {
  ...
  - expected on client: ${JSON.stringify(vnode.children)}`
              ...
              default:
                if (shapeFlag & 1) {
                  if (
                    (domType !== 1 /* ELEMENT */ || vnode.type.toLowerCase() !== node.tagName.toLowerCase()) &&
                    !isTemplateNode(node)
                  ) {
                    nextNode = onMismatch();
                  } else {
                  ...
                  for (const key in props) {
                    ...
                    if (
                      ...
                      ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isOn)(key) &&
                        !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isReservedProp)(key)) || // force hydrate v-bind with .prop modifiers
                      key[0] === '.'
                    ) {
...
- expected on client:`,
        ...
        function propHasMismatch(el, key, clientValue, vnode, instance) {
          ...
          if (key === 'class') {
            ...
            expected = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(clientValue)
              ? clientValue
              : (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.stringifyStyle)(
                  (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.normalizeStyle)(clientValue)
                );
            ...
            if (
              ...
              const cssVars =
                (_a = instance == null ? void 0 : instance.getCssVars) == null ? void 0 : _a.call(instance);
            ...
            (el instanceof SVGElement && (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isKnownSvgAttr)(key)) ||
            (el instanceof HTMLElement &&
              ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isBooleanAttr)(key) ||
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isKnownHtmlAttr)(key)))
          ) {
            if ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isBooleanAttr)(key)) {
              ...
              expected = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isRenderableAttrValue)(clientValue)
                ? String(clientValue)
                : false;
            }
            if (actual !== expected) {
  ...
  You should fix the source of the mismatch.`;
        ...
        function initFeatureFlags() {
          ...
          if (typeof __VUE_PROD_HYDRATION_MISMATCH_DETAILS__ !== 'boolean') {
            ...
            (0,
            _vue_shared__WEBPACK_IMPORTED_MODULE_1__.getGlobalThis)().__VUE_PROD_HYDRATION_MISMATCH_DETAILS__ = false;
          }
...
For more details, see https://link.vuejs.org/feature-flags.`
        ...
        function doWatch(
          source,
          cb,
          { immediate, deep, flush, once, onTrack, onTrigger } = _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ
        ) {
          if (cb && once) {
            const _cb = cb;
            cb = (...args) => {
          ...
          if ((0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isRef)(source)) {
            ...
            forceTrigger = source.some(
              (s) =>
                (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isReactive)(s) ||
                (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isShallow)(s)
            );
            getter = () =>
              source.map((s) => {
          ...
          const effect = new _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.ReactiveEffect(
            getter,
            _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP,
            scheduler
          );
        ...
        function _createVNode(
          ...
          if (props) {
            ...
            if ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isObject)(style)) {
              if (
                (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isProxy)(style) &&
...
Component that was made reactive: `,
        ...
        function guardReactiveProps(props) {
          ...
          return (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isProxy)(props) || isInternalObject(props)
        ...
        function cloneVNode(vnode, extraProps, mergeRef = false, cloneTransition = false) {
          ...
          const cloned = {
            ...
            children:
              true && patchFlag === -1 && (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(children)
            ...
            return (
              ...
              (instance.exposeProxy = new Proxy(
                (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.proxyRefs)(
                  (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.markRaw)(instance.exposed)
                ),
                {
                  get(target, key) {
                    if (key in target) {
            ...
            return {
              ...
              set(value) {
                ...
                if (
                  ...
                  (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasChanged)(value, localValue)
                ) {
                  localValue = value;
                  trigger();
                }
        ...
        function h(type, propsOrChildren, children) {
          ...
          if (l === 2) {
            if (
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isObject)(propsOrChildren) &&
              !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(propsOrChildren)
            ) {
        ...
        function initCustomFormatter() {
              ...
              if (obj.__isVue) {
                ...
                return [
                  ...
                  [
                    'span',
                    vueStyle,
                    (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isShallow)(obj) ? 'ShallowReactive' : 'Reactive',
                  ],
                  '<',
                  formatValue(obj),
                ...
                return [
                  ...
                  [
                    'span',
                    vueStyle,
                    (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isShallow)(obj) ? 'ShallowReadonly' : 'Readonly',
                  ],
                  '<',
                  formatValue(obj),
                  '>',
          ...
          function formatInstance(instance) {
            ...
            if (instance.type.props && instance.props) {
              blocks.push(
                createInstanceBlock('props', (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.toRaw)(instance.props))
              );
            }
            ...
            if (instance.data !== _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ) {
              blocks.push(
                createInstanceBlock('data', (0, _vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.toRaw)(instance.data))
              );
            }
          ...
          function isKeyOfType(Comp, key, type) {
            ...
            if (
              ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(opts) && opts.includes(key)) ||
  ...
  \***********************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ DeprecationTypes: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.DeprecationTypes,
          /* harmony export */ EffectScope: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.EffectScope,
          /* harmony export */ ErrorCodes: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.ErrorCodes,
          /* harmony export */ ErrorTypeStrings: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.ErrorTypeStrings,
          ...
          /* harmony export */ TrackOpTypes: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.TrackOpTypes,
          /* harmony export */ Transition: () => /* binding */ Transition,
          /* harmony export */ TransitionGroup: () => /* binding */ TransitionGroup,
          /* harmony export */ TriggerOpTypes: () =>
            /* reexport safe */ _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.TriggerOpTypes,
        ...
        function patchAttr(
          ...
          isSVG,
          instance,
          isBoolean = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isSpecialBooleanAttr)(key)
        ) {
          if (isSVG && key.startsWith('xlink:')) {
            ...
            if (
              value == null ||
              (isBoolean && !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.includeBooleanAttr)(value))
            ) {
        ...
        function parseName(name) {
          ...
          const event =
            name[2] === ':' ? name.slice(3) : (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.hyphenate)(name.slice(2));
...
Expected function or array of functions, received type ${typeof value}.`
        ...
        class VueElement extends BaseClass {
          ...
          _resolveProps(def) {
            const { props } = def;
            const declaredPropKeys = (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(props)
              ? props
              : Object.keys(props || {});
          ...
          _createVNode() {
            const vnode = (0, _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.createVNode)(
              this._def,
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, this._props)
            );
            if (!this._instance) {
              vnode.ce = (instance) => {
        ...
        function useCssModule(name = '$style') {
          {
            ...
            if (!instance) {
              true &&
                (0, _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.warn)(`useCssModule must be called inside setup()`);
          ...
          setup(props, { slots }) {
            ...
            return () => {
              ...
              children = slots.default
                ? (0, _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.getTransitionRawChildren)(slots.default())
                : [];
              for (let i = 0; i < children.length; i++) {
                const child = children[i];
                if (child.key != null) {
        ...
        const getModelAssigner = (vnode) => {
          ...
          return (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(fn)
            ? (value) => (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.invokeArrayFns)(fn, value)
            : fn;
        };
          ...
          beforeUpdate(el, { value, oldValue, modifiers: { lazy, trim, number } }, vnode) {
            ...
            const elValue =
              (number || el.type === 'number') && !/^0\d/.test(el.value)
                ? (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseToNumber)(el.value)
                : el.value;
          ...
          created(el, { value, modifiers: { number } }, vnode) {
            ...
            addEventListener(el, 'change', () => {
              const selectedVal = Array.prototype.filter
                ...
                .map((o) =>
                  number ? (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseToNumber)(getValue(o)) : getValue(o)
                );
        ...
        function initVModelForSSR() {
          ...
          vModelCheckbox.getSSRProps = ({ value }, vnode) => {
            if ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(value)) {
              if (
                vnode.props &&
                (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseIndexOf)(value, vnode.props.value) > -1
              ) {
                return { checked: true };
              }
            } else if ((0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isSet)(value)) {
        ...
        function ensureRenderer() {
          return (
            renderer || (renderer = (0, _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.createRenderer)(rendererOptions))
          );
        }
        ...
        const createApp = (...args) => {
          ...
          app.mount = (containerOrSelector) => {
            ...
            if (
              !(0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isFunction)(component) &&
              !component.render &&
              !component.template
            ) {
        ...
        function injectNativeTagCheck(app) {
          Object.defineProperty(app.config, 'isNativeTag', {
            value: (tag) =>
              ...
              (0, _vue_shared__WEBPACK_IMPORTED_MODULE_1__.isMathMLTag)(tag),
            writable: false,
          });
        }
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  \**********************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ BaseTransitionPropsValidators: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.BaseTransitionPropsValidators,
          ...
          /* harmony export */ ErrorCodes: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.ErrorCodes,
          /* harmony export */ ErrorTypeStrings: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.ErrorTypeStrings,
          /* harmony export */ Fragment: () =>
          ...
          /* harmony export */ TrackOpTypes: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.TrackOpTypes,
          ...
          /* harmony export */ TriggerOpTypes: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.TriggerOpTypes,
          /* harmony export */ VueElement: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.VueElement,
          /* harmony export */ assertNumber: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.assertNumber,
          /* harmony export */ callWithAsyncErrorHandling: () =>
          ...
          /* harmony export */ defineModel: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.defineModel,
          /* harmony export */ defineOptions: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.defineOptions,
          /* harmony export */ defineProps: () =>
          ...
          /* harmony export */ defineSlots: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.defineSlots,
          /* harmony export */ devtools: () =>
          ...
          /* harmony export */ hasInjectionContext: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.hasInjectionContext,
          ...
          /* harmony export */ mergeModels: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.mergeModels,
          /* harmony export */ mergeProps: () =>
          ...
          /* harmony export */ useModel: () =>
            /* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_0__.useModel,
          /* harmony export */ useSSRContext: () =>
        ...
        /* harmony import */ var _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
  ...
  /******/ (() => {
    ...
    /******/
    /******/ var chunkLoadingGlobal = (self['webpackChunkshapeee'] = self['webpackChunkshapeee'] || []);
  ...
  /******/ var __webpack_exports__ = __webpack_require__.O(undefined, ['app'], () =>
